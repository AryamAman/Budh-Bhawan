...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        // Navigate based on user type - this will be handled by the auth context
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="appearance-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-bits-blue focus:border-bits-blue focus:z-10 sm:text-sm transition-colors"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="appearance-none relative block w-full px-3 py-3 pr-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-bits-blue focus:border-bits-blue focus:z-10 sm:text-sm transition-colors"
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 text-bits-blue focus:ring-bits-blue border-gray-300 rounded"
              />
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-bits-blue hover:bg-bits-navy focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-bits-blue disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
          >
            {isLoading ? (
